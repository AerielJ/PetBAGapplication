		...
		try {
			...
			case 2:
				...
				if (petType == "Dog") {
					...
					// TODO: remove dog from dog vector
				}
				if (petType == "Cat") {
					cats.FindCat(spaceNumber).CheckOut();
					// TODO: remove cat from cat vector
				}
				break;

			case 3:
				system("CLS");              // clear the screen
				cout << "Under construction. Update pet information coming soon." << endl;
				//TODO: add update pet information functionality
				break;
